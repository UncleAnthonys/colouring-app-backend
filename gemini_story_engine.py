...
* **Age Calibration (STRICT — match the tier):**
  - **TODDLER PULSE (under_3, age_3):** Write like a heartbeat. 1-2 short sentences per page. Subject-Verb-Object only. One action and one bold sound word per page (POP! STOMP! BEEP! SPLAT!). Use chant-like repetition ("Up went Milo. Up, up, up!"). Stick to first-100-words vocabulary. The text is a soundtrack to the colouring, not a story to sit and read. A parent reads each page in a single breath.

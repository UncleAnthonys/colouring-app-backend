...
* **Age Calibration (STRICT — match the tier):**
  ...
  - **PRESCHOOL SOUNDTRACK (age_4, age_5):** This is the performance tier. A parent should feel like they're doing a one-person show, not reading a report.
    **SENTENCE LENGTH:** Maximum 8-10 words per sentence. If a sentence has more than 10 words, split it. Short sentences create PACE and DRAMA. "The door swings open. WHOOSH! Balloons everywhere!" NOT "The door swings open and suddenly there are balloons flying everywhere across the room."
    **WORD COUNT:** Maximum 40 words per page for age_4, maximum 50 words per page for age_5. Count them. If you go over, cut adjectives first, then cut connective sentences.
    **VOCABULARY RULE (STRICT):** Use ONLY words a 4-year-old says in the playground. BANNED: cobblestone, gravity, delicate, fragile, enormous, investigate, magnificent, structure, ancient, cascade, illuminated, vibrating, determined, carefully, suddenly. USE INSTEAD: bumpy, heavy, wobbly, huge, big, sticky, squishy, crunchy, slippery, bouncy, slimy, tickly, wiggly, noisy, smelly, yucky, splashy, fizzy.
    **THE PLAYGROUND TEST:** Read every sentence aloud. Would a 4-year-old say it to their friend in a playground? If not, rewrite it simpler. "Erin stands on the bumpy cobblestone street" = FAIL (no 4-year-old says cobblestone). "Erin stands on the bumpy path" = PASS.
    **PERFORMANCE ENERGY:** Every page must give the parent something to DO — a sound to make, a voice to put on, a word to shout. Write for the parent's VOICE, not their eyes. Alliteration ("slippery, slidey, squelchy"), onomatopoeia (CRASH, SPLAT, BOING), and rhythm changes (short-short-short-LONG) make reading aloud feel like a performance.
    ...
    **EXAMPLE OF BAD AGE_4 WRITING:**
    "Louise holds a big star balloon. The shop door rattles. She carefully walks toward the back of the shop to find more balloons." (Too long, too calm, no performance energy, "carefully" is passive)

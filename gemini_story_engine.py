...
* **Age Calibration (STRICT — match the tier):**
  - **TODDLER PULSE (under_3 ONLY):** Pure board book. The REPEATING ANCHOR is the engine of the story — not sound effects. Real board books work because the child knows what's coming next and shouts it with the parent.
    **STRUCTURE:**
    Page 1: Set up the goal in plain words. WHO wants WHAT. "Limey wants the star on top." (No sound word needed — just tell us the goal clearly.)
    Pages 2-4: Each page is ONE attempt that fails, followed by the SAME refrain phrase every time. The refrain fires BECAUSE the attempt failed. Each attempt must be DIFFERENT — a new method, a new obstacle, a new place. Never repeat the same action twice.
    Page 5: The pattern BREAKS — the character succeeds. The refrain is replaced with a warm, celebratory ending. A different phrase that signals "we did it."
    ...
    **EXAMPLES OF A GOOD UNDER_3 STORY:**
    Page 1: "Limey wants the star on top." (goal — no sound needed)
    Page 2: "Limey climbs the blocks. CRASH! They tumble down. Too high, Limey!" (sound fits — blocks falling)
    Page 3: "Limey jumps and jumps. Not even close! Too high, Limey!" (no sound — jumping doesn't make a noise worth noting)
    Page 4: "Limey stacks a chair on the blocks. WOBBLE! Too high, Limey!" (sound fits — wobbly furniture)
    Page 5: "Limey grabs the star! Limey did it! YAY!" (pattern breaks — celebration replaces refrain)

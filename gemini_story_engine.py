...
* **Age Calibration (STRICT — match the tier):**
  ...
  - **PRESCHOOL SOUNDTRACK (age_4, age_5):** This is the performance tier. A parent should feel like they're doing a one-person show, not reading a report.
    ...
    **VOCABULARY RULE (STRICT):** Use ONLY words a 4-year-old knows. Replace every fancy word with a simple one. "Cobblestone" → "bumpy path". "Machinery" → "big machine". "Glistening" → "shiny". "Delicate" → "wobbly". A 4-year-old's vocabulary is: big, small, fast, slow, hot, cold, sticky, squishy, wobbly, bouncy, heavy, loud, scary, funny, yucky, smelly, bumpy, slippery, crunchy, fluffy, slimy, tickly.
...
Write 3-5 sentences per page with natural flow. The story structure and length are fine — just use SIMPLER WORDS.
BANNED WORDS — never use these: cobblestone, gravity, delicate, fragile, enormous, investigate, magnificent, structure, ancient, cascade, illuminated, vibrating, determined, shimmering, glistening, narrow, machinery, mechanism, bristles, hovering, sparkly, precisely, extraordinary, groaning, cascading.
USE INSTEAD: bumpy, heavy, wobbly, huge, big, sticky, squishy, crunchy, slippery, bouncy, slimy, tickly, wiggly, noisy, smelly, yucky, splashy, fizzy, squelchy, lumpy, scratchy, fluffy, wooshy, clunky, gloopy, mushy.
THE PLAYGROUND TEST: Read every word aloud. Would a 4-year-old KNOW this word? "Cobblestone" = NO. "Bumpy path" = YES. "Machinery" = NO. "Big machine" = YES. "Glistening" = NO. "Shiny" = YES. Replace every fancy word with a simple one.""")
